  ...
  return (
    <div className={styles.container}>
      ...
      <header className={styles.header}>
        {home ? (
          <>
            <img src={image} className={`${styles.headerHomeImage} ${utilStyles.borderCircle}`} alt={name}/>
            <h1 className={utilStyles.heading2Xl}>{name}</h1>
          </>
        ) : (
          <>
            <Link href="/">
              <img src={image} className={`${styles.headerImage} ${utilStyles.borderCircle}`} alt={name}/>
            </Link>
